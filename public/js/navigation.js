...
class Navigation {
  ...
  static pages = [
    ...
    { id: 'mi-ia', name: 'Mi IA', url: '/dashboard/mi-ia.html', icon: 'fas fa-robot' },
    { id: 'estadisticas', name: 'Estadísticas', url: '/dashboard/estadisticas.html', icon: 'fas fa-chart-line' }
  ];
