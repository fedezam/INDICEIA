...
export const SCORE_WEIGHTS = {
  ...
  // Temporal — peak moment boost
  // +4pts por cada peakMoment activo en este momento.
  // Ejemplo: pizzería viernes 21hs → "viernes-noche" activo → +4pts
  // Expandible: ver temporal.resolver.js para agregar feriados, clima, eventos especiales
  peakMoment:         4,
};
...
export const REASONS_CATALOG = {
  ...
  peakMoment:         'momento de mayor actividad para este negocio',
};
