...
export const RUBRO_PROFILES = {
  ...
  // ── Oficios ──────────────────────────────────
  OFI: {
    intents:   ['plomero', 'reparacion', 'urgencia', 'presupuesto', 'instalacion'],
    moods:     ['urgente', 'practico'],
    occasions: ['rotura', 'obra', 'mantenimiento', 'emergencia'],
    audiences: ['hogares', 'propietarios', 'constructoras'],
    urgency:   'high',
    bestFor:   ['reparacion-urgente', 'instalacion', 'mantenimiento'],
    peakMoments:  ['manana-temprano', 'cualquier-hora', 'post-feriado'],
    seasonalTags: ['todo-el-ano', 'invierno'],
    quickActions: [
      'pedir presupuesto',
  ...
  // ── OFI: Oficios / Servicios del Hogar ───────────────────────
  OFI: {
    intents:   ['reparacion', 'instalacion', 'mantenimiento', 'presupuesto', 'urgencia-hogar'],
    moods:     ['practico', 'urgente', 'confiable'],
    occasions: ['rotura', 'obra', 'mantenimiento', 'mudanza'],
