...
export function compileServiceClose(context, comercioId) {
  ...
  return [
    ...
    `⟦wa_url:https://indiceia.dev/api/service-redirect/${comercioId}?servicio={{SERVICIO_ID}}&modalidad={{MODALIDAD}}&zona={{ZONA_URLENCODED}}&consulta={{CONSULTA_URLENCODED}}${demoParam}∧si_combo⇒servicio={{SERVICIO_ID_1}},{{SERVICIO_ID_2}},...⟧`,
    MENSAJE_RESUELTO_POR_ENDPOINT,
