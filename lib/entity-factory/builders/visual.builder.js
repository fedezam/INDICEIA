 ...
 * 2. Fetch al artifact.html del template elegido
...
export async function buildVisual(context, goods, comercioId) {
  try {
    ...
    const templateUrl = `${TEMPLATES_BASE_URL}/${templateId}/artifact.html`;
    ...
    const html = templateHtml
      .replace('{{NOMBRE}}',     escapeForHtml(nombre))
    ...
    // 5. Guardar en Firestore — proceso autonomo, maneja su propio mundo
