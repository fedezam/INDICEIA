...
export function buildContext(data, comercioId, referralCode) {
  ...
  // Tipo de entidad
  if (hasData(data.entityType)) context.tipo = data.entityType;
  ...
  // Identidad — prestador (mi-perfil)
  // nombre sobrescribe nombreComercio si existe — prestador tiene prioridad
  ...
  // direccion — compartida entre comercio y prestador
